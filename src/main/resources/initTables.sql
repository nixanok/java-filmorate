...
DROP TABLE IF EXISTS REQUEST_FRIENDS;
...
CREATE TABLE IF NOT EXISTS PUBLIC.REQUEST_FRIENDS (
	SENDING_ID INTEGER NOT NULL,
	RECEIVING_ID INTEGER NOT NULL,
	CONSTRAINT REQUEST_FRIENDS_PK PRIMARY KEY (SENDING_ID, RECEIVING_ID),
	CONSTRAINT REQUEST_FRIENDS_SENDING_ID_FK FOREIGN KEY (SENDING_ID) REFERENCES PUBLIC.USERS(USER_ID),
	CONSTRAINT REQUEST_FRIENDS_RECEIVING_ID_FK FOREIGN KEY (RECEIVING_ID) REFERENCES PUBLIC.USERS(USER_ID)
);
CREATE INDEX IF NOT EXISTS REQUEST_FRIENDS_INDEX ON PUBLIC.REQUEST_FRIENDS(SENDING_ID, RECEIVING_ID);
